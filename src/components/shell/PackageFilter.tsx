...
export default function PackageFilter({ baseUrl }: PackageFilterProps) {
  ...
  return (
    <form 
      ...
      className="grid grid-cols-1 md:grid-cols-4 gap-4 p-4 bg-bg-card rounded-2xl border border-border-light mb-6 animate-in fade-in slide-in-from-top-1 duration-300 shadow-sm"
    >
      <Input 
      ...
      <div className="flex items-end gap-2">
        <Button 
          type="submit" 
          className="flex-1 py-2.5 text-sm shadow-sm"
        >
          Terapkan
        </Button>
        <Button 
          ...
          type="button"
          onClick={handleReset}
          className="px-3 border-border-light hover:text-danger"
          title="Reset Filter"
        >
          <X size={18} />
        </Button>
